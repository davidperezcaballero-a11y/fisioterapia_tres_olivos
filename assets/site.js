...
const brand = (light = false) => `
  <span class="brand">
    <img class="brand-logo" src="${assetsBase}logo-3olivos${light ? "-light" : ""}.png?v=${assetVersion}" alt="Fisioterapia 3 Olivos" width="302" height="360">
  </span>`;
        ...
        <div class="footer-grid">
          ...
          <div>
            ...
            <ul class="footer-list">
              ...
              <li><a href="/presentacion/">La clínica</a></li>
            </ul>
          </div>
          <div>
...
if (mobileActionsTarget) {
  mobileActionsTarget.innerHTML = `
    <aside class="mobile-actions" aria-label="Contacto rápido">
      <a class="btn btn-coral" href="${phoneHref}">${icon("phone")} 91 735 33 03</a>
      <a class="btn btn-primary" href="${whatsappHref}">${icon("message")} 630 18 74 46</a>
    </aside>`;
}
